...
void char1_read_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
	...
	*/
	...
	rsp.attr_value.value[1] = tiempo_giro_atr/100;
	rsp.attr_value.value[2] = tiempo_giro_der/100;
	rsp.attr_value.value[3] = tiempo_giro_izq/100;
	rsp.attr_value.value[4] = tiempo_alto_md;
